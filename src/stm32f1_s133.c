...
/** @defgroup STM32F1_LOW_LEVEL 
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on STM32F1 Kit from STMicroelectronics.
  * @{
  */ 

/** @defgroup STM32F1_LOW_LEVEL_Private_TypesDefinitions
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32F1_LOW_LEVEL_Private_Defines
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32F1_LOW_LEVEL_Private_Macros
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32F1_LOW_LEVEL_Private_Variables
  * @{
  */ 
...
/** @defgroup STM32F1_LOW_LEVEL_Private_FunctionPrototypes
  * @{
  */ 
...
/** @defgroup STM32F1_LOW_LEVEL_Private_Functions
  * @{
  */ 
...
void SD_LowLevel_Init(void)
{
	...
	/*!< Configure PC.08, PC.09, PC.10, PC.11, PC.12 pin: D0, D1, D2, D3, CLK pin */
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10 | GPIO_Pin_11 | GPIO_Pin_12;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;	// by micca
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
	GPIO_Init(GPIOC, &GPIO_InitStructure);
